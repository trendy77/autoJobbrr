...
let menutitle =  tF0.title + ' :' + tF0.value;
let id0 = chrome.contextMenus.create({"title": menutitle,  "parentMenuItemId": parent,"contexts":["selection"],"id": menutitle,
                                       "onclick": upContext});
let mt1 =  tF1.title + ' :' + tF1.value;
let id1 = chrome.contextMenus.create({"title": mt1,  "parentMenuItemId": parent,"contexts":["selection"],"id": mt1,
                                       "onclick": upContext});
