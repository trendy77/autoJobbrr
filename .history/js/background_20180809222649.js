...
function addRec(info, tab) {
  ...
  var radio1 = chrome.contextMenus.create({"title": "Rec Agency", "type": "radio","contexts": ["selection"],
										   "onclick":addRec});
  var radio2 = chrome.contextMenus.create({"title": "Email", "type": "radio","contexts": ["selection"]
