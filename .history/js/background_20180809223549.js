...
var parent = chrome.contextMenus.create({"id":"parent","title": "jobSEEKr","contexts":["selection"],"onclick": upContext});
var menutitle =  tF0.title + ' :' + tF0.value;
var id0 = chrome.contextMenus.create({"title": menutitle,  "parentMenuItemId": parent,"contexts":["selection"],"id": menutitle,
                                       "onclick": upContext});
var mt1 =  tF1.title + ' :' + tF1.value;
var id1 = chrome.contextMenus.create({"title": mt1,  "parentMenuItemId": parent,"contexts":["selection"],"id": mt1,
                                       "onclick": upContext});

/*let id2 = chrome.contextMenus.create({"title": menutitle,  "parentMenuItemId": parent,"contexts":["selection"],"id": menutitle,
                                       "onclick": upContext});
let id3 = chrome.contextMenus.create({"title": menutitle,  "parentMenuItemId": parent,"contexts":["selection"],"id": menutitle,
                                       "onclick": upContext});
let id4 = chrome.contextMenus.create({"title": menutitle,  "parentMenuItemId": parent,"contexts":["selection"],"id": menutitle,
                                       "onclick": upContext});
let id5 = chrome.contextMenus.create({"title": menutitle,  "parentMenuItemId": parent,"contexts":["selection"],"id": menutitle,
                                       "onclick": upContext});
let id6 = chrome.contextMenus.create({"title": menutitle,  "parentMenuItemId": parent,"contexts":["selection"],"id": menutitle,
                                       "onclick": upContext});
let id7 = chrome.contextMenus.create({"title": menutitle,  "parentMenuItemId": parent,"contexts":["selection"],"id": menutitle,
                                       "onclick": upContext});
*/
  ...
  var radio1 = chrome.contextMenus.create({"title": "Rec Agency", "type": "radio","contexts": ["selection"],"onclick":addRec});
										   
  var radio2 = chrome.contextMenus.create({"title": "Email", "type": "radio","contexts": ["selection"],"onclick":addRec});
