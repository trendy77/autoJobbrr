...
var gobutton, signin_button, xhr_button, revoke_button, exec_info_div,
...
var executionAPIExample = (function() {
	...
	var signin_button, xhr_button, revoke_button, exec_info_div, exec_data,
		exec_result;
	...
	function executionAPIResponse(response) {
		...
		if (response.response.result.status == 'ok') {
			...
			info = 'Data has been entered into <a href="' + response.response.result.doc +
	...
	return {
		...
		onload: function() {
			...
			xhr_button.addEventListener('click', sendDataToExecutionAPI.bind(
				xhr_button, true));
