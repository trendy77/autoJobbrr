...
<html lang="en">
<head>
    <title>Code coverage report for fast-redact/lib/validator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">fast-redact/lib</a> validator.js
    </h1>
    <div class='clearfix'>
  ...
  return function validate ({paths, serialize, censor}) {
    ...
    paths.forEach((s) =&gt; {
      ...
      try {
        ...
        rx.lastIndex = 0
        <span class="missing-if-branch" title="if path not taken" >I</span>if (rx.test(expr) === false) <span class="cstat-no" title="statement not covered" >throw Error()</span>
