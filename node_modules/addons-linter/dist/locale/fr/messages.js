module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "A CSS syntax error was encountered":[ "Une erreur de syntaxe CSS a été rencontrée" ],
      ...
      "This API has not been implemented by Firefox.":[ "Cette API n’a pas été implémentée dans Firfox." ],
      ...
      "Violation of Mozilla conditions of use.":[ "Violation des conditions d’utilisation Mozilla." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Une revue supplémentaire est nécessaire lorsque content_security_policy est définie de manière spécifique." ],
      "The \"name\" property must be a string.":[ "La propriété « name » doit être une chaîne de caractères." ],
      "See http://mzl.la/1STmr48 (MDN Docs) for more information.":[ "Voir https://mzl.la/1STmr48 (MDN Docs) pour plus d’informations." ],
      "The \"version\" property must be a string.":[ "La propriété « version » doit être une chaîne de caractères." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Voir https://mzl.la/1kXIADa (MDN Docs) pour plus d’informations." ],
      "The \"version\" property uses a Firefox-specific format.":[ "La propriété « version » s’appuie sur un format spécifique à Firefox." ],
