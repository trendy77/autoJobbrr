module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "The field is invalid.":[ "قطعہ ناجائز ہے۔" ],
      ...
      "Forbidden content found in add-on.":[ "اظافہ جات میں ممنوعہ مواد پایا گیا۔" ],
      "This add-on contains forbidden content.":[ "" ],
      "Icons must be square.":[ "آئیکن کا چکور ہونا ظروری پے۔" ],
      ...
      "The permission type is unsupported.":[ "اجازت قسم غیر تائید شدہ ہے۔" ],
      "Unsupported image extension":[ "غیر تائید شدہ تصویر توسیع" ],
      "Icons should be one of JPG/JPEG, WebP, GIF, PNG or SVG.":[ "" ],
      "Empty language directory":[ "" ],
      "messages.json file missing in \"%(path)s\"":[ "" ],
      "Unknown permission.":[ "نامعلوم اجازت۔" ],
      ...
      "\"update_url\" is not allowed.":[ "\"update_url\" کی اجازت نہیں۔" ],
      "The field is required.":[ "قطعہ درکار ہے۔" ],
      "The \"update_url\" property is not used by Firefox.":[ "\"update_url\" کی خصوصیت Firefoxکی جانب سے استعمال نہیں ہوتی۔" ] } } }